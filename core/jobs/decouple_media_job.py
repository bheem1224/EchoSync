...
from core.task_manager.task_queue import TaskCategory, register_job
...
def register_decouple_media_job(
    interval_seconds: int | None = 86400 * 1000, enabled: bool = True
):
    """
