...
class UserTrackInteraction:
    ...
    plugin_item_id: (
        str  # Provider's unique track ID (e.g., Plex ratingKey, MusicBrainz MBID)
    )
    ...
    rating: float | None = None  # User's rating (1-5 stars, or provider-specific scale)
    last_played_at: datetime | None = None  # When the track was last played
