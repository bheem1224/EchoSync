...
from .models import SoulSyncTrack
from .scoring import ScoringProfile, ScoringWeights
...
class WeightedMatchingEngine:
    ...
    def calculate_match(
        ...
        # ===== STEP 0: FINGERPRINT MATCHING (if available) =====
    ...
    def _fuzzy_match(self, a: str, b: str) -> float:
        ...
        # Use shared normalization utility to ensure consistency with database
    ...
    def _normalize_string_for_comparison(self, s: str) -> str:
        """
        DEPRECATED: Use utils.text_normalization.normalize_for_matching() instead.
