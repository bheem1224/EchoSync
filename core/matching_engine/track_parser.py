...
from .fingerprinting import FingerprintCache, FingerprintGenerator
...
class TrackParser:
    ...
    def __init__(self, config: ParseConfig | None = None):
        ...
        self.fingerprint_cache: FingerprintCache | None = None
    ...
    def _parse_filename_core(self, raw_string: Any) -> EchosyncTrack | None:
    ...
    def _try_parse_patterns(self, working_string: str) -> dict[str, str] | None:
    ...
    def _extract_track_numbers(self, text: str) -> tuple[int | None, int | None]:
...
def parse_file(
    file_path: str, config: ParseConfig | None = None, generate_fingerprint: bool = True
) -> EchosyncTrack | None:
    """
