...
EchoSync is a media management orchestrator designed to help users organize, sync, and manage metadata for legally acquired audio files. EchoSync does not host, provide, or distribute copyrighted audio files.

The developers of EchoSync do not condone, encourage, or facilitate copyright infringement. Users are solely responsible for ensuring that they possess the legal right to access, download, and manage any media processed through this software and its third-party plugins.
