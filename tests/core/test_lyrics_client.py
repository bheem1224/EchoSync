...
from plugins.lrclib.client import LRCLibClient as LyricsClient
...
def mock_lrclib_api():
    ...
    with patch('plugins.lrclib.client.LrcLibAPI') as mock_api_class:
...
@patch('plugins.lrclib.client.LrcLibAPI', None)
