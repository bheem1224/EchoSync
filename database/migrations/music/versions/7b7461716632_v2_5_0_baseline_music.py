...
def upgrade() -> None:
    ...
    if "albums" not in tables:
        ...
        with op.batch_alter_table("albums", schema=None) as batch_op:
            batch_op.create_index(
                batch_op.f("ix_albums_title"), ["title"], unique=False
            )
    ...
    if "artist_aliases" not in tables:
        ...
        with op.batch_alter_table("artist_aliases", schema=None) as batch_op:
            batch_op.create_index(
                batch_op.f("ix_artist_aliases_artist_id"), ["artist_id"], unique=False
            )
    ...
    if "tracks" not in tables:
        ...
        with op.batch_alter_table("tracks", schema=None) as batch_op:
            batch_op.create_index(
                batch_op.f("ix_tracks_musicbrainz_id"), ["musicbrainz_id"], unique=False
            )
            batch_op.create_index(
                batch_op.f("ix_tracks_title"), ["title"], unique=False
            )
    ...
    if "audio_fingerprints" not in tables:
        ...
        with op.batch_alter_table("audio_fingerprints", schema=None) as batch_op:
            batch_op.create_index(
                batch_op.f("ix_audio_fingerprints_track_id"), ["track_id"], unique=False
            )
    ...
    if "external_identifiers" not in tables:
        op.create_table(
            ...
            sa.PrimaryKeyConstraint("id"),
            sa.UniqueConstraint(
                "provider_source", "provider_item_id", name="uq_provider_item"
            ),
        )
        with op.batch_alter_table("external_identifiers", schema=None) as batch_op:
            batch_op.create_index(
                batch_op.f("ix_external_identifiers_track_id"),
                ["track_id"],
                unique=False,
            )
    ...
    if "track_aliases" not in tables:
        op.create_table(
            ...
            sa.PrimaryKeyConstraint("id"),
            sa.UniqueConstraint(
                "track_id", "locale", "script", "name", name="uq_track_alias"
            ),
        )
        with op.batch_alter_table("track_aliases", schema=None) as batch_op:
            batch_op.create_index(
                batch_op.f("ix_track_aliases_track_id"), ["track_id"], unique=False
            )
