...
<div class="min-h-screen bg-gray-900 text-white p-6">
    <div class="max-w-7xl mx-auto space-y-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h1 class="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-600">Media Manager</h1>
                <p class="text-gray-400 text-sm">Library Hygiene & Administration</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <!-- Placeholder for Distribution (could use a mini chart library, keeping it simple text for now) -->
                            ...
                            {#each actionQueue as track}
                                <div class="p-4 hover:bg-gray-750 transition-colors flex items-center justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-2 shrink-0">
                                        ...
                                        <!-- Confirm Action (Force Execute) -->
                                        <!-- Note: The prompt says "Add a 'Pardon/Lock' button".
                                             It implies the 'Execute' happens via the Prune/Upgrade jobs eventually,
                                             or maybe we want manual execute here?
                                             "Force Upgrade" and "Force Delete" are listed as context actions in Task 3.
                                             Here, strictly following Task 1: "Add a 'Pardon/Lock' button"
                                        -->
                                    </div>
                                </div>
                            {/each}
