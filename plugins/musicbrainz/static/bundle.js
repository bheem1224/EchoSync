...
var ui = /* @__PURE__ */ Q("<div class=\"p-5 text-center text-secondary\">Loading...</div>"), di = /* @__PURE__ */ Q("<input type=\"text\" class=\"px-3 py-2 bg-background/50 border border-border rounded-global text-sm text-primary w-full box-border opacity-70 cursor-not-allowed select-all\" readonly=\"\" disabled=\"\"/> <p class=\"text-xs text-secondary mt-1\" style=\"margin-top:6px;\">Add this URI as a callback URL in your MusicBrainz application settings.</p>", 1), fi = /* @__PURE__ */ Q("<button class=\"px-4 py-2 bg-white/10 text-primary border border-white/20 rounded-global transition-colors hover:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95\">+ Add Account</button>"), pi = /* @__PURE__ */ Q("<span class=\"text-[12px] px-2 py-1 rounded-[4px] bg-[#00e676]/20 text-[#00e676]\">✓ Authenticated</span>"), mi = /* @__PURE__ */ Q("<span class=\"text-[12px] px-2 py-1 rounded-[4px] bg-yellow-500/20 text-yellow-500\">⚠ Not Authenticated</span>"), hi = /* @__PURE__ */ Q("<span class=\"text-[12px] px-2 py-1 rounded-[4px] bg-[#ba6415]/20 text-[#ba6415]\">● Active</span>"), gi = /* @__PURE__ */ Q("<div class=\"flex justify-between items-center p-3 bg-white/5 border border-white/10 rounded-global\"><div class=\"flex flex-col gap-1\"><div class=\"font-medium text-[14px]\"> </div> <div class=\"flex gap-[6px] flex-wrap\"><!> <!></div></div> <div class=\"flex gap-2 items-center flex-wrap\"><button class=\"bg-transparent text-[#ba6415] px-2 py-1 hover:underline active:scale-95 transition-all duration-200\"> </button> <button> </button> <button class=\"px-4 py-2 bg-red-500/20 text-red-500 border-none rounded-global transition-colors hover:bg-red-500/30 active:scale-95\">✕</button></div></div>"), _i = /* @__PURE__ */ Q("<div class=\"p-4 text-center text-secondary text-sm\">No accounts added yet. Click \"Add Account\" to get started.</div>"), vi = /* @__PURE__ */ Q("<div class=\"mb-6\"><h3 class=\"m-0 mb-4 text-base font-semibold\">Custom API Base URL</h3> <p class=\"text-xs text-secondary mt-1\">Point this to a local MusicBrainz Docker container to go 100% offline.</p> <div class=\"flex flex-col gap-3\"><div class=\"flex flex-col gap-1\"><label class=\"text-[13px] font-medium text-primary\" for=\"mb-api-base-url\">API Base URL</label> <input id=\"mb-api-base-url\" type=\"text\" class=\"px-3 py-2 bg-background border border-border rounded-global text-sm text-primary w-full box-border focus:outline-none focus:border-accent\" placeholder=\"https://musicbrainz.org/ws/2\"/></div> <button class=\"px-4 py-2 bg-accent text-black font-medium rounded-global transition-colors hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95\">Save Settings</button></div></div> <div class=\"mb-6\"><h3 class=\"m-0 mb-4 text-base font-semibold\">Application Credentials</h3> <p class=\"text-xs text-secondary mt-1\">Register an application at <a href=\"https://musicbrainz.org/account/applications\" target=\"_blank\" rel=\"noopener noreferrer\">musicbrainz.org/account/applications</a> to obtain a Client ID and Secret. These are required for OAuth logins and ISRC submissions.</p> <div class=\"flex flex-col gap-3\"><div class=\"flex flex-col gap-1\"><label class=\"text-[13px] font-medium text-primary\" for=\"mb-client-id\">Client ID</label> <input id=\"mb-client-id\" type=\"text\" class=\"px-3 py-2 bg-background border border-border rounded-global text-sm text-primary w-full box-border focus:outline-none focus:border-accent\" placeholder=\"Enter your MusicBrainz Client ID\"/></div> <div class=\"flex flex-col gap-1\"><label class=\"text-[13px] font-medium text-primary\" for=\"mb-client-secret\">Client Secret</label> <div class=\"relative flex items-center\"><input id=\"mb-client-secret\" class=\"px-3 py-2 bg-background border border-border rounded-global text-sm text-primary w-full box-border focus:outline-none focus:border-accent\"/> <button type=\"button\" class=\"absolute right-2 bg-transparent border-none cursor-pointer text-lg p-1 opacity-60 hover:opacity-100 transition-opacity active:scale-95\"> </button></div></div> <button class=\"px-4 py-2 bg-accent text-black font-medium rounded-global transition-colors hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95\"> </button></div></div> <div class=\"mb-6\"><div class=\"mb-3\"><h3 class=\"m-0 mb-4 text-base font-semibold\">OAuth Redirect URI (Auto-generated)</h3> <button class=\"px-4 py-2 bg-white/10 text-primary border border-white/20 rounded-global transition-colors hover:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95\"> </button></div> <!></div> <div class=\"mb-6\"><div class=\"mb-3\"><h3 class=\"m-0 mb-4 text-base font-semibold\"> </h3> <p class=\"text-xs text-secondary mt-1\">Each account represents a MusicBrainz user that will authenticate via OAuth.\n          Authenticated accounts can contribute ISRCs and metadata to MusicBrainz.</p> <!></div> <div class=\"flex flex-col gap-2\"></div></div>", 1), yi = /* @__PURE__ */ Q("<div class=\"fixed inset-0 bg-black/60 flex items-center justify-center z-[1000]\"><div class=\"bg-[#1e1e2e] rounded-[10px] p-0 min-w-[420px] max-w-[90vw] border border-white/15\"><div class=\"flex justify-between items-center px-5 py-4 border-b border-white/10\"><h3 class=\"m-0 mb-4 text-base font-semibold\">Add MusicBrainz Account</h3> <button class=\"bg-transparent border-none text-[18px] cursor-pointer text-secondary p-0 leading-none active:scale-95 transition-all duration-200\">✕</button></div> <div class=\"p-5 flex flex-col gap-[14px]\"><label class=\"flex flex-col gap-[6px]\"><span class=\"text-[13px] font-medium text-primary\">Display Name</span> <input type=\"text\" placeholder=\"e.g. My MusicBrainz Username\" class=\"px-3 py-2 bg-background border border-border rounded-global text-sm text-primary w-full box-border focus:outline-none focus:border-accent\"/></label> <p class=\"text-[12px] text-secondary m-0\">Give this slot a friendly name. After adding, click \"Authenticate\" to link it\n          to a real MusicBrainz account via OAuth.</p></div> <div class=\"flex justify-end gap-[10px] px-5 py-4 border-t border-white/10\"><button class=\"px-4 py-2 bg-white/10 text-primary border border-white/20 rounded-global transition-colors hover:bg-white/15 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95\">Cancel</button> <button class=\"px-4 py-2 bg-accent text-black font-medium rounded-global transition-colors hover:opacity-90 disabled:opacity-50 disabled:cursor-not-allowed active:scale-95\"> </button></div></div></div>"), bi = /* @__PURE__ */ Q("<section class=\"p-6 bg-surface backdrop-blur-md border border-glass-border rounded-global mb-4\"><div class=\"flex justify-between items-center mb-5 pb-3 border-b border-glass-border\"><div class=\"flex items-center gap-3\"><h2 class=\"m-0 text-xl font-semibold\">MusicBrainz</h2> <span class=\"text-[12px] px-2 py-1 rounded-[4px] bg-[#ba6415]/20 text-[#ba6415]\">Metadata</span></div></div> <!></section> <!>", 1);
function xi(e, t) {
	Ve(t, !1);
