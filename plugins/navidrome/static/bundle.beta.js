...
var qr = /* @__PURE__ */ Q("<span class=\"status-badge active-server svelte-6qi2q9\">● Active</span>"), Jr = /* @__PURE__ */ Q("<span class=\"status-badge authenticated svelte-6qi2q9\">✓ Authenticated</span>"), Yr = /* @__PURE__ */ Q("<span class=\"status-badge connected svelte-6qi2q9\">● Connected</span>"), Xr = /* @__PURE__ */ Q("<span class=\"status-badge disconnected svelte-6qi2q9\">⚠ Disconnected</span>"), Zr = /* @__PURE__ */ Q("<div class=\"loading svelte-6qi2q9\">Loading...</div>"), Qr = /* @__PURE__ */ Q("<button class=\"btn-secondary svelte-6qi2q9\"> </button>"), $r = /* @__PURE__ */ Q("<button class=\"btn-secondary svelte-6qi2q9\"> </button>"), ei = /* @__PURE__ */ Q("<div class=\"section svelte-6qi2q9\"><h3 class=\"svelte-6qi2q9\">Server Configuration</h3> <div class=\"form-group svelte-6qi2q9\"><label class=\"svelte-6qi2q9\"><span class=\"label-text svelte-6qi2q9\">Server URL</span> <input type=\"text\" placeholder=\"http://192.168.1.100:4533\" class=\"input svelte-6qi2q9\"/> <span class=\"help-text svelte-6qi2q9\">Enter your Navidrome server URL (include port, typically :4533)</span></label> <label class=\"svelte-6qi2q9\"><span class=\"label-text svelte-6qi2q9\">Username</span> <input type=\"text\" placeholder=\"Enter username\" class=\"input svelte-6qi2q9\"/></label> <label class=\"svelte-6qi2q9\"><span class=\"label-text svelte-6qi2q9\">Password</span> <div class=\"password-field svelte-6qi2q9\"><input class=\"input svelte-6qi2q9\"/> <button type=\"button\" class=\"password-toggle svelte-6qi2q9\"> </button></div></label> <div class=\"border-t border-gray-700 my-4 pt-4\"><echosync-path-mapping-editor></echosync-path-mapping-editor></div> <div class=\"button-group svelte-6qi2q9\"><button class=\"btn-primary svelte-6qi2q9\"> </button> <!> <!></div></div></div>", 2), ti = /* @__PURE__ */ Q("<section class=\"navidrome-card card svelte-6qi2q9\"><div class=\"card-header svelte-6qi2q9\"><div class=\"header-left svelte-6qi2q9\"><h2 class=\"svelte-6qi2q9\">Navidrome</h2> <!> <!> <!></div> <button class=\"btn-secondary svelte-6qi2q9\"> </button></div> <!></section>"), ni = {
	hash: "svelte-6qi2q9",
	code: ".navidrome-card.svelte-6qi2q9 {padding:20px;margin-bottom:16px;}.card-header.svelte-6qi2q9 {display:flex;justify-content:space-between;align-items:center;margin-bottom:20px;padding-bottom:12px;border-bottom:1px solid var(--border-color, rgba(255,255,255,0.1));}.header-left.svelte-6qi2q9 {display:flex;align-items:center;gap:12px;}.card-header.svelte-6qi2q9 h2:where(.svelte-6qi2q9) {margin:0;font-size:20px;font-weight:600;}.status-badge.svelte-6qi2q9 {font-size:12px;padding:4px 8px;border-radius:4px;}.status-badge.connected.svelte-6qi2q9 {background:rgba(0, 230, 118, 0.2);color:#00e676;}.status-badge.disconnected.svelte-6qi2q9 {background:rgba(255, 152, 0, 0.2);color:#ff9800;}.status-badge.authenticated.svelte-6qi2q9 {background:rgba(0, 230, 118, 0.2);color:#00e676;}.status-badge.active-server.svelte-6qi2q9 {background:rgba(59, 130, 246, 0.2);color:#3b82f6;font-weight:600;}.section.svelte-6qi2q9 {margin-bottom:24px;}.section.svelte-6qi2q9 h3:where(.svelte-6qi2q9) {margin:0 0 16px 0;font-size:16px;font-weight:600;}.form-group.svelte-6qi2q9 {display:flex;flex-direction:column;gap:16px;}label.svelte-6qi2q9 {display:flex;flex-direction:column;gap:6px;}.label-text.svelte-6qi2q9 {font-size:13px;font-weight:500;color:var(--text-primary);}.help-text.svelte-6qi2q9 {font-size:12px;color:var(--muted);}.input.svelte-6qi2q9 {padding:10px 12px;border-radius:6px;border:1px solid var(--border-color, rgba(255,255,255,0.1));background:var(--input-bg, rgba(0,0,0,0.2));color:var(--text-primary);font-size:14px;}.input.svelte-6qi2q9:focus {outline:none;border-color:var(--primary, #00e676);}.password-field.svelte-6qi2q9 {position:relative;display:flex;align-items:center;}.password-field.svelte-6qi2q9 .input:where(.svelte-6qi2q9) {flex:1;padding-right:45px;}.password-toggle.svelte-6qi2q9 {position:absolute;right:8px;background:transparent;border:none;cursor:pointer;font-size:18px;padding:4px 8px;opacity:0.6;transition:opacity 0.2s;}.password-toggle.svelte-6qi2q9:hover {opacity:1;}.button-group.svelte-6qi2q9 {display:flex;gap:12px;flex-wrap:wrap;}.btn-primary.svelte-6qi2q9, .btn-secondary.svelte-6qi2q9 {padding:10px 20px;border-radius:6px;border:none;font-size:14px;font-weight:500;cursor:pointer;transition:all 0.2s;}.btn-primary.svelte-6qi2q9 {background:var(--primary, #00e676);color:#000;}.btn-primary.svelte-6qi2q9:hover:not(:disabled) {background:var(--primary-hover, #00d368);}.btn-secondary.svelte-6qi2q9 {background:transparent;color:var(--text-primary);border:1px solid var(--border-color, rgba(255,255,255,0.2));}.btn-secondary.svelte-6qi2q9:hover:not(:disabled) {background:rgba(255,255,255,0.05);}.btn-primary.svelte-6qi2q9:disabled, .btn-secondary.svelte-6qi2q9:disabled {opacity:0.5;cursor:not-allowed;}.loading.svelte-6qi2q9 {padding:20px;text-align:center;color:var(--muted);}"
};
function ri(e, t) {
	He(t, !1), Tr(e, ni);
	...
	async function g() {
		try {
			P(h, !0), await fetch(`${n()}/navidrome/activate`, { method: "POST" }), console.log("Navidrome activated as media server"), await _();
		} catch (e) {
	...
	async function _() {
		try {
			let e = await fetch(`${n()}/navidrome/settings`);
			...
			console.error("Failed to load Navidrome settings:", e), console.error("Failed to load Navidrome settings");
		}
	}
	async function ee() {
		if (!Z(r).trim()) {
		...
		try {
			P(u, !0), await fetch(`${n()}/navidrome/settings`, {
				method: "POST",
			...
			}), console.log("Navidrome settings saved"), await _();
		} catch (e) {
			console.error("Failed to save Navidrome settings:", e), console.error("Failed to save settings");
		} finally {
			P(u, !1);
		}
	}
	async function te() {
		try {
			P(d, !0);
			let e = await fetch(`${n()}/navidrome/test-connection`, { method: "POST" });
			e.data?.connected && (console.log(`Connected to Navidrome ${e.data.version}`), await _());
		} catch (e) {
...
customElements.define("navidrome-dashboard-card", Kr(ri, { apiBase: {} }, [], [], { mode: "open" }));
//#endregion
