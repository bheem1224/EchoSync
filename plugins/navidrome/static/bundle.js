...
var qr = /* @__PURE__ */ Q("<span class=\"status-badge active svelte-6qi2q9\">● Active</span>"), Jr = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-6qi2q9\">✓ Authenticated</span>"), Yr = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-6qi2q9\">● Connected</span>"), Xr = /* @__PURE__ */ Q("<span class=\"status-badge warning svelte-6qi2q9\">⚠ Disconnected</span>"), Zr = /* @__PURE__ */ Q("<div class=\"loading-state svelte-6qi2q9\">Loading...</div>"), Qr = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-6qi2q9\"> </button>"), $r = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-6qi2q9\"> </button>"), ei = /* @__PURE__ */ Q("<div class=\"settings-section svelte-6qi2q9\"><h3 class=\"section-title svelte-6qi2q9\">Server Configuration</h3> <div class=\"form-grid svelte-6qi2q9\"><label class=\"form-field svelte-6qi2q9\"><span class=\"field-label svelte-6qi2q9\">Server URL</span> <input type=\"text\" placeholder=\"http://192.168.1.100:4533\" class=\"input-field svelte-6qi2q9\"/> <span class=\"helper-text svelte-6qi2q9\">Enter your Navidrome server URL (include port, typically :4533)</span></label> <label class=\"form-field svelte-6qi2q9\"><span class=\"field-label svelte-6qi2q9\">Username</span> <input type=\"text\" placeholder=\"Enter username\" class=\"input-field svelte-6qi2q9\"/></label> <label class=\"form-field svelte-6qi2q9\"><span class=\"field-label svelte-6qi2q9\">Password</span> <div class=\"password-wrapper svelte-6qi2q9\"><input class=\"input-field svelte-6qi2q9\"/> <button type=\"button\" class=\"toggle-visibility svelte-6qi2q9\"> </button></div></label> <div class=\"path-mappings svelte-6qi2q9\"><echosync-path-mapping-editor></echosync-path-mapping-editor></div> <div class=\"actions-row svelte-6qi2q9\"><button class=\"btn-primary svelte-6qi2q9\"> </button> <!> <!></div></div></div>", 2), ti = /* @__PURE__ */ Q("<section class=\"plugin-card svelte-6qi2q9\"><div class=\"card-header svelte-6qi2q9\"><div class=\"header-left svelte-6qi2q9\"><h2 class=\"card-title svelte-6qi2q9\">Navidrome</h2> <div class=\"badges svelte-6qi2q9\"><!> <!> <!></div></div> <button class=\"btn-ghost svelte-6qi2q9\"> </button></div> <!></section>"), ni = {
	hash: "svelte-6qi2q9",
	code: ".plugin-card.svelte-6qi2q9 {background:var(--glass, rgba(20, 24, 31, 0.7));backdrop-filter:blur(12px);border:1px solid var(--glass-border, rgba(255,255,255,0.08));border-radius:var(--radius, 12px);padding:24px;margin-bottom:24px;color:var(--text-main, #fff);}.card-header.svelte-6qi2q9 {display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;padding-bottom:12px;border-bottom:1px solid var(--border-subtle, rgba(255,255,255,0.08));}.header-left.svelte-6qi2q9 {display:flex;align-items:center;gap:16px;}.card-title.svelte-6qi2q9 {margin:0;font-size:20px;font-weight:700;}.badges.svelte-6qi2q9 {display:flex;gap:8px;}.status-badge.svelte-6qi2q9 {font-size:10px;padding:2px 8px;border-radius:4px;font-weight:700;}.status-badge.active.svelte-6qi2q9 {background:rgba(59, 130, 246, 0.15);color:#3b82f6;}.status-badge.success.svelte-6qi2q9 {background:rgba(34, 197, 94, 0.15);color:#22c55e;}.status-badge.warning.svelte-6qi2q9 {background:rgba(234, 179, 8, 0.15);color:#eab308;}.btn-ghost.svelte-6qi2q9 {padding:8px 16px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);color:var(--text-main, #fff);border-radius:8px;font-size:13px;cursor:pointer;transition:all 0.2s;}.btn-ghost.svelte-6qi2q9:hover {background:rgba(255,255,255,0.1);}.btn-primary.svelte-6qi2q9 {padding:10px 20px;background:var(--color-primary, #14b8a6);color:#000;border:none;border-radius:8px;font-weight:600;cursor:pointer;transition:all 0.2s;}.loading-state.svelte-6qi2q9 {padding:24px;text-align:center;color:var(--text-muted, #64748b);}.settings-section.svelte-6qi2q9 {margin-top:16px;}.section-title.svelte-6qi2q9 {margin:0 0 16px 0;font-size:16px;font-weight:600;}.form-grid.svelte-6qi2q9 {display:flex;flex-direction:column;gap:16px;}.form-field.svelte-6qi2q9 {display:flex;flex-direction:column;gap:6px;}.field-label.svelte-6qi2q9 {font-size:13px;color:var(--text-muted, #64748b);}.input-field.svelte-6qi2q9 {width:100%;padding:10px 14px;background:var(--bg-input, #08080a);border:1px solid var(--border-subtle, rgba(255,255,255,0.08));border-radius:8px;color:var(--text-main, #fff);font-size:14px;transition:all 0.2s;}.input-field.svelte-6qi2q9:focus {outline:none;border-color:var(--color-primary, #14b8a6);box-shadow:0 0 0 2px rgba(20, 184, 166, 0.1);}.password-wrapper.svelte-6qi2q9 {position:relative;display:flex;align-items:center;}.toggle-visibility.svelte-6qi2q9 {position:absolute;right:12px;background:none;border:none;cursor:pointer;opacity:0.6;color:#fff;}.helper-text.svelte-6qi2q9 {font-size:11px;color:var(--text-muted, #64748b);}.path-mappings.svelte-6qi2q9 {padding:16px 0;border-top:1px solid rgba(255,255,255,0.05);}.actions-row.svelte-6qi2q9 {display:flex;gap:12px;flex-wrap:wrap;margin-top:8px;}"
};
function ri(e, t) {
	Ve(t, !1), Tr(e, ni);
...
customElements.define("navidrome-dashboard-card", Kr(ri, { apiBase: {} }, [], []));
//#endregion
