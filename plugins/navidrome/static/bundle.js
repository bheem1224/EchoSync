...
function ei(e, t) {
	...
	async function g() {
		try {
			F(h, !0), await fetch(`${n()}/navidrome/activate`, { method: "POST" }), console.log("Navidrome activated as media server"), await _();
		} catch (e) {
...
customElements.define("navidrome-dashboard-card", Wr(ei, { apiBase: {} }, [], []));
//#endregion
