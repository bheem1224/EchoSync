...
var Yr = /* @__PURE__ */ mr("<span class=\"status-badge active svelte-1uhbaav\">● Active</span>"), Xr = /* @__PURE__ */ mr("<span class=\"status-badge success svelte-1uhbaav\">✓ Authenticated</span>"), Zr = /* @__PURE__ */ mr("<span class=\"status-badge success svelte-1uhbaav\">● Connected</span>"), Qr = /* @__PURE__ */ mr("<span class=\"status-badge warning svelte-1uhbaav\">⚠ Disconnected</span>"), $r = /* @__PURE__ */ mr("<div class=\"loading-state svelte-1uhbaav\">Loading...</div>"), ei = /* @__PURE__ */ mr("<button class=\"btn-ghost svelte-1uhbaav\"> </button>"), ti = /* @__PURE__ */ mr("<div class=\"settings-section svelte-1uhbaav\"><h3 class=\"section-title svelte-1uhbaav\">Server Configuration</h3> <div class=\"form-grid svelte-1uhbaav\"><label class=\"form-field svelte-1uhbaav\"><span class=\"field-label svelte-1uhbaav\">Server URL</span> <input type=\"text\" placeholder=\"http://192.168.1.100:8096\" class=\"input-field svelte-1uhbaav\"/> <span class=\"helper-text svelte-1uhbaav\">Enter your Jellyfin server URL (include port, typically :8096)</span></label> <label class=\"form-field svelte-1uhbaav\"><span class=\"field-label svelte-1uhbaav\">Username</span> <input type=\"text\" placeholder=\"Enter username\" class=\"input-field svelte-1uhbaav\"/></label> <label class=\"form-field svelte-1uhbaav\"><span class=\"field-label svelte-1uhbaav\">Password</span> <div class=\"password-wrapper svelte-1uhbaav\"><input class=\"input-field svelte-1uhbaav\"/> <button type=\"button\" class=\"toggle-visibility svelte-1uhbaav\"> </button></div></label> <div class=\"actions-row svelte-1uhbaav\"><button class=\"btn-primary svelte-1uhbaav\"> </button> <!> <!></div></div></div>"), ni = /* @__PURE__ */ mr("<section class=\"plugin-card svelte-1uhbaav\"><div class=\"card-header svelte-1uhbaav\"><div class=\"header-left svelte-1uhbaav\"><h2 class=\"card-title svelte-1uhbaav\">Jellyfin</h2> <div class=\"badges svelte-1uhbaav\"><!> <!> <!></div></div> <button class=\"btn-ghost svelte-1uhbaav\"> </button></div> <!></section>"), ri = {
	hash: "svelte-1uhbaav",
...
customElements.define("jellyfin-dashboard-card", Jr(ii, { apiBase: {} }, [], [], { mode: "open" }));
//#endregion
