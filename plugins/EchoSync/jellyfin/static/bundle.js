...
var qr = /* @__PURE__ */ Q("<span class=\"status-badge active svelte-1uhbaav\">● Active</span>"), Jr = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-1uhbaav\">✓ Authenticated</span>"), Yr = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-1uhbaav\">● Connected</span>"), Xr = /* @__PURE__ */ Q("<span class=\"status-badge warning svelte-1uhbaav\">⚠ Disconnected</span>"), Zr = /* @__PURE__ */ Q("<div class=\"loading-state svelte-1uhbaav\">Loading...</div>"), Qr = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-1uhbaav\"> </button>"), $r = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-1uhbaav\"> </button>"), ei = /* @__PURE__ */ Q("<div class=\"settings-section svelte-1uhbaav\"><h3 class=\"section-title svelte-1uhbaav\">Server Configuration</h3> <div class=\"form-grid svelte-1uhbaav\"><label class=\"form-field svelte-1uhbaav\"><span class=\"field-label svelte-1uhbaav\">Server URL</span> <input type=\"text\" placeholder=\"http://192.168.1.100:8096\" class=\"input-field svelte-1uhbaav\"/> <span class=\"helper-text svelte-1uhbaav\">Enter your Jellyfin server URL (include port, typically :8096)</span></label> <label class=\"form-field svelte-1uhbaav\"><span class=\"field-label svelte-1uhbaav\">Username</span> <input type=\"text\" placeholder=\"Enter username\" class=\"input-field svelte-1uhbaav\"/></label> <label class=\"form-field svelte-1uhbaav\"><span class=\"field-label svelte-1uhbaav\">Password</span> <div class=\"password-wrapper svelte-1uhbaav\"><input class=\"input-field svelte-1uhbaav\"/> <button type=\"button\" class=\"toggle-visibility svelte-1uhbaav\"> </button></div></label> <div class=\"path-mappings svelte-1uhbaav\"><echosync-path-mapping-editor></echosync-path-mapping-editor></div> <div class=\"actions-row svelte-1uhbaav\"><button class=\"btn-primary svelte-1uhbaav\"> </button> <!> <!></div></div></div>", 2), ti = /* @__PURE__ */ Q("<section class=\"plugin-card svelte-1uhbaav\"><div class=\"card-header svelte-1uhbaav\"><div class=\"header-left svelte-1uhbaav\"><h2 class=\"card-title svelte-1uhbaav\">Jellyfin</h2> <div class=\"badges svelte-1uhbaav\"><!> <!> <!></div></div> <button class=\"btn-ghost svelte-1uhbaav\"> </button></div> <!></section>"), ni = {
	hash: "svelte-1uhbaav",
	code: ".plugin-card.svelte-1uhbaav {background:var(--bg-surface);backdrop-filter:blur(12px);border:1px solid var(--border-subtle);border-radius:var(--radius, 12px);padding:24px;margin-bottom:24px;color:var(--text-primary);}.card-header.svelte-1uhbaav {display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;padding-bottom:12px;border-bottom:1px solid var(--border-subtle);}.header-left.svelte-1uhbaav {display:flex;align-items:center;gap:16px;}.card-title.svelte-1uhbaav {margin:0;font-size:20px;font-weight:700;}.badges.svelte-1uhbaav {display:flex;gap:8px;}.status-badge.svelte-1uhbaav {font-size:10px;padding:2px 8px;border-radius:4px;font-weight:700;}.status-badge.active.svelte-1uhbaav {background:rgba(59, 130, 246, 0.15);color:var(--color-primary);}.status-badge.success.svelte-1uhbaav {background:rgba(34, 197, 94, 0.15);color:#22c55e;}.status-badge.warning.svelte-1uhbaav {background:rgba(234, 179, 8, 0.15);color:#eab308;}.btn-ghost.svelte-1uhbaav {padding:8px 16px;background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);color:var(--text-primary);border-radius:8px;font-size:13px;cursor:pointer;transition:all 0.2s;}.btn-ghost.svelte-1uhbaav:hover {background:rgba(255,255,255,0.1);}.btn-primary.svelte-1uhbaav {padding:10px 20px;background:var(--color-primary);color:var(--bg-canvas);border:none;border-radius:8px;font-weight:600;cursor:pointer;transition:all 0.2s;}.loading-state.svelte-1uhbaav {padding:24px;text-align:center;color:var(--text-muted);}.settings-section.svelte-1uhbaav {margin-top:16px;}.section-title.svelte-1uhbaav {margin:0 0 16px 0;font-size:16px;font-weight:600;}.form-grid.svelte-1uhbaav {display:flex;flex-direction:column;gap:16px;}.form-field.svelte-1uhbaav {display:flex;flex-direction:column;gap:6px;}.field-label.svelte-1uhbaav {font-size:13px;color:var(--text-muted);}.input-field.svelte-1uhbaav {width:100%;padding:10px 14px;background:var(--bg-surface-elevated);border:1px solid var(--border-subtle);border-radius:8px;color:var(--text-primary);font-size:14px;transition:all 0.2s;}.input-field.svelte-1uhbaav:focus {outline:none;border-color:var(--color-primary);box-shadow:0 0 0 2px rgba(20, 184, 166, 0.1);}.password-wrapper.svelte-1uhbaav {position:relative;display:flex;align-items:center;}.toggle-visibility.svelte-1uhbaav {position:absolute;right:12px;background:none;border:none;cursor:pointer;opacity:0.6;color:var(--text-primary);}.helper-text.svelte-1uhbaav {font-size:11px;color:var(--text-muted);}.path-mappings.svelte-1uhbaav {padding:16px 0;border-top:1px solid rgba(255,255,255,0.05);}.actions-row.svelte-1uhbaav {display:flex;gap:12px;flex-wrap:wrap;margin-top:8px;}"
};
function ri(e, t) {
	Ve(t, !1), Tr(e, ni);
