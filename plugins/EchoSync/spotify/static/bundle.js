...
function qt(e, t, n) {
	...
	if (r !== null) for (var i = We(), a = r.length, o = 0; o < a; o++) {
		...
		if (!(!i && s === G)) {
			...
			if (l && A(s, t), c & 2) {
				var u = s;
				M?.delete(u), c & 65536 || (c & 512 && (G === null || !(G.f & 2097152)) && (s.f |= ce), qt(u, w, n));
			} else if (l) {
				var d = s;
...
var ci = /* @__PURE__ */ Q("<div class=\"loading-state svelte-16m7f8c\">Loading...</div>"), li = /* @__PURE__ */ Q("<div class=\"form-grid svelte-16m7f8c\"><label class=\"form-field svelte-16m7f8c\"><span class=\"field-label svelte-16m7f8c\">Client ID</span> <input type=\"text\" placeholder=\"Enter Spotify Client ID\" class=\"input-field svelte-16m7f8c\"/></label> <label class=\"form-field svelte-16m7f8c\"><span class=\"field-label svelte-16m7f8c\">Client Secret</span> <input type=\"password\" placeholder=\"Enter Spotify Client Secret\" class=\"input-field svelte-16m7f8c\"/></label> <label class=\"form-field svelte-16m7f8c\"><span class=\"field-label svelte-16m7f8c\">Redirect URI (Immutable)</span> <input type=\"text\" class=\"input-field readonly svelte-16m7f8c\" readonly=\"\" disabled=\"\"/></label> <button class=\"btn-primary svelte-16m7f8c\"> </button></div>"), ui = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-16m7f8c\">+ Add Account</button>"), di = /* @__PURE__ */ Q("<div class=\"add-account-form svelte-16m7f8c\"><input type=\"text\" placeholder=\"Account name\" class=\"input-field svelte-16m7f8c\"/> <div class=\"form-actions svelte-16m7f8c\"><button class=\"btn-primary svelte-16m7f8c\">Add</button> <button class=\"btn-ghost svelte-16m7f8c\">Cancel</button></div></div>"), fi = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-16m7f8c\">✓ Authenticated</span>"), pi = /* @__PURE__ */ Q("<span class=\"status-badge warning svelte-16m7f8c\">⚠ Not Authenticated</span>"), mi = /* @__PURE__ */ Q("<span class=\"status-badge active svelte-16m7f8c\">● Active</span>"), hi = /* @__PURE__ */ Q("<div class=\"account-item svelte-16m7f8c\"><div class=\"account-info svelte-16m7f8c\"><div class=\"account-name svelte-16m7f8c\"> </div> <div class=\"account-badges svelte-16m7f8c\"><!> <!></div></div> <div class=\"account-actions svelte-16m7f8c\"><button class=\"link-btn svelte-16m7f8c\"> </button> <button> </button> <button class=\"btn-danger svelte-16m7f8c\">✕</button></div></div>"), gi = /* @__PURE__ */ Q("<div class=\"empty-accounts svelte-16m7f8c\">No accounts added yet</div>"), _i = /* @__PURE__ */ Q("<div class=\"settings-section svelte-16m7f8c\"><div class=\"section-header svelte-16m7f8c\"><h3 class=\"section-title svelte-16m7f8c\">Global Credentials</h3> <button class=\"btn-ghost svelte-16m7f8c\"> </button></div> <!></div> <div class=\"settings-section svelte-16m7f8c\"><div class=\"section-header svelte-16m7f8c\"><h3 class=\"section-title svelte-16m7f8c\"> </h3> <!></div> <!> <div class=\"accounts-list svelte-16m7f8c\"></div></div>", 1), vi = /* @__PURE__ */ Q("<section class=\"plugin-card svelte-16m7f8c\"><div class=\"card-header svelte-16m7f8c\"><div class=\"header-left svelte-16m7f8c\"><h2 class=\"card-title svelte-16m7f8c\">Spotify</h2> <span class=\"type-badge svelte-16m7f8c\">Streaming Service</span></div></div> <!></section>"), yi = {
	hash: "svelte-16m7f8c",
	code: ".plugin-card.svelte-16m7f8c {background:var(--bg-surface);backdrop-filter:blur(12px);border:1px solid var(--glass-border, rgba(255, 255, 255, 0.08));border-radius:var(--radius, 12px);padding:24px;margin-bottom:24px;color:var(--text-primary);}.card-header.svelte-16m7f8c {display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;padding-bottom:16px;border-bottom:1px solid var(--border-subtle, rgba(255, 255, 255, 0.08));}.header-left.svelte-16m7f8c {display:flex;align-items:center;gap:12px;}.card-title.svelte-16m7f8c {margin:0;font-size:20px;font-weight:700;}.type-badge.svelte-16m7f8c {font-size:11px;padding:4px 8px;background:rgba(20, 184, 166, 0.15);color:var(--color-primary);border-radius:4px;font-weight:600;text-transform:uppercase;}.loading-state.svelte-16m7f8c {padding:24px;text-align:center;color:var(--text-muted);}.settings-section.svelte-16m7f8c {margin-bottom:24px;}.section-header.svelte-16m7f8c {display:flex;justify-content:space-between;align-items:center;margin-bottom:16px;}.section-title.svelte-16m7f8c {margin:0;font-size:16px;font-weight:600;color:var(--text-primary);}.form-grid.svelte-16m7f8c {display:flex;flex-direction:column;gap:16px;}.form-field.svelte-16m7f8c {display:flex;flex-direction:column;gap:8px;}.field-label.svelte-16m7f8c {font-size:13px;font-weight:500;color:var(--text-muted);}.input-field.svelte-16m7f8c {width:100%;padding:10px 14px;background:var(--bg-surface-elevated);border:1px solid var(--border-subtle, rgba(255, 255, 255, 0.08));border-radius:8px;color:var(--text-primary);font-size:14px;transition:all 0.2s;}.input-field.svelte-16m7f8c:focus {outline:none;border-color:var(--color-primary);box-shadow:0 0 0 2px rgba(20, 184, 166, 0.1);}.input-field.readonly.svelte-16m7f8c {opacity:0.6;cursor:not-allowed;}.btn-primary.svelte-16m7f8c {padding:10px 20px;background:var(--color-primary);color:var(--bg-canvas);border:none;border-radius:8px;font-weight:600;cursor:pointer;transition:all 0.2s;}.btn-primary.svelte-16m7f8c:hover {opacity:0.9;}.btn-ghost.svelte-16m7f8c {padding:8px 16px;background:rgba(255, 255, 255, 0.05);border:1px solid rgba(255, 255, 255, 0.1);color:var(--text-primary);border-radius:8px;font-size:13px;cursor:pointer;transition:all 0.2s;}.btn-ghost.svelte-16m7f8c:hover {background:rgba(255, 255, 255, 0.1);}.add-account-form.svelte-16m7f8c {background:rgba(255, 255, 255, 0.03);padding:16px;border-radius:8px;display:flex;flex-direction:column;gap:12px;margin-bottom:16px;}.form-actions.svelte-16m7f8c {display:flex;gap:8px;}.accounts-list.svelte-16m7f8c {display:flex;flex-direction:column;gap:8px;}.account-item.svelte-16m7f8c {display:flex;justify-content:space-between;align-items:center;padding:12px 16px;background:rgba(255, 255, 255, 0.03);border:1px solid rgba(255, 255, 255, 0.05);border-radius:8px;}.account-info.svelte-16m7f8c {display:flex;flex-direction:column;gap:4px;}.account-name.svelte-16m7f8c {font-weight:600;font-size:14px;}.account-badges.svelte-16m7f8c {display:flex;gap:8px;}.status-badge.svelte-16m7f8c {font-size:10px;padding:2px 6px;border-radius:4px;font-weight:700;}.status-badge.success.svelte-16m7f8c {background:rgba(34, 197, 94, 0.15);color:#22c55e;}.status-badge.warning.svelte-16m7f8c {background:rgba(234, 179, 8, 0.15);color:#eab308;}.status-badge.active.svelte-16m7f8c {background:rgba(20, 184, 166, 0.15);color:var(--color-primary);}.account-actions.svelte-16m7f8c {display:flex;gap:12px;align-items:center;}.link-btn.svelte-16m7f8c {background:none;border:none;color:var(--color-primary);font-size:13px;font-weight:600;cursor:pointer;}.link-btn.svelte-16m7f8c:hover {text-decoration:underline;}.btn-danger.svelte-16m7f8c {background:rgba(239, 68, 68, 0.15);color:var(--color-danger);border:none;padding:8px 12px;border-radius:6px;cursor:pointer;}.empty-accounts.svelte-16m7f8c {text-align:center;padding:16px;color:var(--text-muted);font-size:13px;background:rgba(255, 255, 255, 0.02);border-radius:8px;border:1px dashed rgba(255, 255, 255, 0.1);}"
};
function bi(e, t) {
	He(t, !1), Rr(e, yi);
	...
	async function f() {
		try {
			let e = await (await fetch("/api/providers/spotify/settings")).json();
	...
	async function p() {
		...
		try {
			P(u, !0), await fetch("/api/providers/spotify/settings", {
				method: "POST",
	...
	async function m() {
		try {
			P(o, (await (await fetch("/api/accounts/spotify")).json())?.accounts || []);
		} catch (e) {
...
customElements.define("spotify-dashboard-card", si(bi, { apiBase: {} }, [], []));
//#endregion
