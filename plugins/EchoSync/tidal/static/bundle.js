...
var mt = class {
	...
	#v(e) {
		...
		let r = () => {
			...
			t = !0, n && Ne(), this.#s !== null && Fn(this.#s, () => {
				this.#s = null;
			}), this.#S(() => {
				this.#b();
			});
	...
	#y() {
		...
		e && (this.is_pending = !0, this.#o = B(() => e(this.#e)), Ze(() => {
			...
			e.append(t), this.#a = this.#S(() => B(() => this.#r(t))), this.#u === 0 && (this.#e.before(e), this.#c = null, Fn(this.#o, () => {
				this.#o = null;
			}), this.#x(j));
		}));
	}
	...
	#S(e) {
		var t = G, n = H, r = k;
		Wn(this.#i), W(this.#i), Ge(this.#i.ctx);
		try {
			return Lt.ensure(), e();
		} catch (e) {
			return $e(e), null;
...
function gt() {
	var e = G, t = H, n = k, r = j;
	return function(i = !0) {
		Wn(e), W(t), Ge(n), i && !(e.f & 16384) && (r?.activate(), r?.apply());
	};
}
function _t(e = !0) {
	Wn(null), W(null), Ge(null), e && j?.deactivate();
}
function vt() {
...
function xt(e, t, n) {
	...
	return En(() => {
		...
		let u = (e, t = void 0) => {
			l?.(), c.delete(n), t !== bt && (r.activate(), t ? (o.f |= ue, $t(o, t)) : (o.f & 8388608 && (o.f ^= ue), $t(o, e)), r.deactivate());
		};
...
function wt(e) {
	...
	if (!Hn && i !== null && e.v !== r && i.f & 24576) return Pe(), e.v;
	Wn(i);
	try {
		e.f &= ~se, Ct(e), t = tr(e);
	} finally {
...
function Tt(e) {
	var t = wt(e);
	if (!e.equals(t) && (e.wv = Qn(), (!j?.is_fork || e.deps === null) && (j === null ? e.v = t : (j.capture(e, t, !0), kt?.capture(e, t, !0)), e.deps === null))) {
		A(e, x);
		return;
	}
	Hn || (M === null ? nt(e) : (vn() || j?.is_fork) && M.set(e, t));
}
function Et(e) {
	if (e.effects !== null) for (let t of e.effects) (t.teardown || t.ac) && (t.teardown?.(), t.ac !== null && lt(() => {
		t.ac.abort(ye), t.ac = null;
	}), t.fn !== null && (t.teardown = _), rr(t, 0), jn(t));
}
function Dt(e) {
	...
	#_(e, t, n) {
		...
		for (var r = e.first; r !== null;) {
			...
			if (!(a && i & 1024 || i & 8192 || this.#f.has(r)) && r.fn !== null) {
				a ? r.f ^= x : i & 4 ? t.push(r) : $n(r) && (i & 16 && this.#d.add(r), ir(r));
				var o = r.first;
				if (o !== null) {
					r = o;
					continue;
...
function Vt(e) {
	...
	if (t !== 0) {
		for (var n = 0; n < t;) {
			var r = e[n++];
			if (!(r.f & 24576) && $n(r) && (Bt = /* @__PURE__ */ new Set(), ir(r), r.deps === null && r.first === null && r.nodes === null && r.teardown === null && r.ac === null && Pn(r), Bt?.size > 0)) {
				Jt.clear();
				for (let e of Bt) {
...
function P(e, t, n = !1) {
	return H !== null && (!U || H.f & 131072) && Je() && H.f & 4325394 && (Gn === null || !Gn.has(e)) && Me(), $t(e, n ? rn(t) : t, Pt);
}
function $t(e, t, n = null) {
	if (!e.equals(t)) {
		...
		e.wv = Qn(), nn(e, S, n), Je() && G !== null && G.f & 1024 && !(G.f & 96) && (J === null ? qn([e]) : J.push(e)), !r.is_fork && qt.size > 0 && !Yt && en();
	}
	return t;
}
function en() {
	...
	if (r !== null) for (var i = Je(), a = r.length, o = 0; o < a; o++) {
		...
		if (!(!i && s === G)) {
			...
			if (l && A(s, t), c & 131072) qt.add(s);
				...
				var u = s;
				M?.delete(u), c & 65536 || (c & 512 && (G === null || !(G.f & 2097152)) && (s.f |= se), nn(u, C, n));
			} else if (l) {
				var d = s;
...
function rn(e) {
	...
	let t = h(e);
	if (t !== p && t !== m) return e;
	var n = /* @__PURE__ */ new Map(), i = a(e), o = /* @__PURE__ */ Zt(0), s = null, c = Xn, l = (e) => {
		if (Xn === c) return e();
		var t = H, n = Xn;
		W(null), Zn(c);
		var r = e();
	...
	return i && n.set("length", /* @__PURE__ */ Zt(e.length, s)), new Proxy(e, {
		...
		get(t, i, a) {
			...
			if (o === void 0 && (!c || d(t, i)?.writable) && (o = l(() => /* @__PURE__ */ Zt(rn(c ? t[i] : r), s)), n.set(i, o)), o !== void 0) {
				var u = Y(o);
				return u === r ? void 0 : u;
			}
		...
		has(e, t) {
			...
			return (i !== void 0 || G !== null && (!a || d(e, t)?.writable)) && (i === void 0 && (i = l(() => /* @__PURE__ */ Zt(a ? rn(e[t]) : r, s)), n.set(t, i)), Y(i) === r) ? !1 : a;
		},
		set(e, t, a, c) {
			...
			if (u === void 0) (!f || d(e, t)?.writable) && (u = l(() => /* @__PURE__ */ Zt(void 0, s)), P(u, rn(a)), n.set(t, u));
			else {
				f = u.v !== r;
				var h = l(() => rn(a));
				P(u, h);
...
function ln() {
	if (an === void 0) {
		...
		sn = d(t, "firstChild").get, cn = d(t, "nextSibling").get, g(e) && (e[he] = void 0, e[me] = null, e[ge] = void 0, e.__e = void 0), g(n) && (n[_e] = void 0);
	}
}
function F(e = "") {
...
function V(e, t = !0) {
	var n = !1;
	(t || e.f & 262144) && e.nodes !== null && e.nodes.end !== null && (Nn(e.nodes.start, e.nodes.end), n = !0), e.f |= ne, jn(e, t && !n), rr(e, 0);
...
function $n(e) {
	...
	if (t & 2 && (e.f &= ~se), t & 4096) {
		for (var n = e.deps, r = n.length, i = 0; i < r; i++) {
			var a = n[i];
			if ($n(a) && Tt(a), a.wv > e.wv) return !0;
		}
		t & 512 && M === null && A(e, x);
	}
	return !1;
...
function er(e, t, n = !0) {
	...
	if (r !== null && !(Gn !== null && Gn.has(e))) for (var i = 0; i < r.length; i++) {
		var a = r[i];
		a.f & 2 ? er(a, t, !1) : t === a && (n ? A(a, S) : a.f & 1024 && A(a, C), Wt(a));
	}
}
function tr(e) {
	var t = K, n = q, r = J, i = H, a = Gn, o = k, s = U, c = Xn, l = e.f;
	K = null, q = 0, J = null, H = l & 96 ? null : e, Gn = null, Ge(e.ctx), U = !1, Xn = ++Yn, e.ac !== null && (lt(() => {
		e.ac.abort(ye);
	}), e.ac = null);
	try {
		e.f |= ce;
		...
		if (K !== null) {
			var m;
			if (p || rr(e, q), f !== null && q > 0) for (f.length = q + K.length, m = 0; m < K.length; m++) f[q + m] = K[m];
			else e.deps = f = K;
			if (vn() && e.f & 512) for (m = q; m < f.length; m++) (f[m].reactions ??= []).push(e);
		} else !p && f !== null && q < f.length && (rr(e, q), f.length = q);
		if (Je() && J !== null && !U && f !== null && !(e.f & 6146)) for (m = 0; m < J.length; m++) er(J[m], e);
		if (i !== null && i !== e) {
		...
		e.f ^= ce, K = t, q = n, J = r, H = i, Gn = a, Ge(o), U = s, Xn = c;
	}
}
function nr(e, t) {
	let n = t.reactions;
...
function Y(e) {
	var t = (e.f & 2) != 0;
	if (Bn?.add(e), H !== null && !U && !(G !== null && G.f & 16384) && (Gn === null || !Gn.has(e))) {
		var n = H.deps;
		if (H.f & 2097152) e.rv < Yn && (e.rv = Yn, K === null && n !== null && n[q] === e ? q++ : K === null ? K = [e] : K.push(e));
		else {
	...
	if (t) {
		...
		if (Hn) {
			var a = i.v;
			return (!(i.f & 1024) && i.reactions !== null || sr(i)) && (a = wt(i)), Jt.set(i, a), a;
		}
		var o = (i.f & 512) == 0 && !U && H !== null && (Vn || (H.f & 512) != 0), c = (i.f & te) === 0;
		$n(i) && (o && (i.f |= 512), Tt(i)), o && !c && (Dt(i), or(i));
	}
...
function or(e) {
	if (e.f |= 512, e.deps !== null) for (let t of e.deps) (t.reactions ??= []).push(e), t.f & 2 && !(t.f & 512) && (Dt(t), or(t));
}
function sr(e) {
	if (e.v === r) return !0;
	if (e.deps === null) return !1;
	for (let t of e.deps) if (Jt.has(t) || t.f & 2 && sr(t)) return !0;
	return !1;
}
function X(e) {
	var t = U;
...
function cr(e) {
	if (!(typeof e != "object" || !e || e instanceof EventTarget)) {
		if (de in e) lr(e);
			...
			let n = e[t];
			typeof n == "object" && n && de in n && lr(n);
		}
	}
}
...
function pr(e, t, n, r = {}) {
	function i(e) {
		if (r.capture || hr.call(t, e), !e.cancelBubble) return lt(() => n?.call(this, e));
	}
...
function hr(e) {
	...
	if (a = i[o] || e.target, a !== t) {
		...
		try {
			...
			e[ur] = t, delete e.currentTarget, W(d), Wn(f);
		}
	}
}
//#endregion
...
function Q(e, t) {
	...
	return () => {
		...
		i === void 0 && (i = vr(a ? e : "<!>" + e), n || (i = /* @__PURE__ */ un(i)));
...
function wr(e, t) {
	...
	try {
		for (var o = /* @__PURE__ */ un(r); o && (o.nodeType !== 8 || o.data !== "[");) o = /* @__PURE__ */ I(o);
		if (!o) throw n;
		Le(!0), D(o);
		let i = Er(e, {
			...t,
		...
		return i !== n && console.warn("Failed to hydrate: ", i), t.recover === !1 && Oe(), ln(), fn(r), Le(!1), Cr(e, t);
	} finally {
		Le(i), D(a);
	}
}
...
function Er(e, { target: t, anchor: r, props: i = {}, events: a, context: o, intro: s = !0, transformError: l }) {
	...
	var u = void 0, d = wn(() => {
		...
		pt(s, { pending: () => {} }, (t) => {
			Ke({});
			var r = k;
			if (o && (r.c = o), a && (i.$$events = a), T && yr(t, null), u = e(t, i) || {}, T && (G.nodes.end = E, E === null || E.nodeType !== 8 || E.data !== "]")) throw Fe(), n;
			qe();
		}, l);
		...
		return f(c(dr)), fr.add(f), () => {
			for (var e of d) for (let r of [t, document]) {
				var n = Tr.get(r), i = n.get(e);
				--i == 0 ? (r.removeEventListener(e, hr), n.delete(e), n.size === 0 && Tr.delete(r)) : n.set(e, i);
			}
			fr.delete(f), s !== r && s.parentNode?.removeChild(s);
		};
	});
	return Dr.set(u, d), u;
}
			...
			for (let [e, r] of this.#t) {
				...
				let i = () => {
					if (Array.from(this.#e.values()).includes(e)) {
						...
						zn(r, t), t.append(F()), this.#n.set(e, {
							effect: r,
							fragment: t
						});
					} else V(r);
...
function Ar(t) {
	k === null && xe("onMount"), e && k.l !== null ? jr(k).m.push(t) : bn(() => {
		let e = X(t);
...
function Fr(e, t, n = !0) {
	...
	for (var i = 0; i < t.length; i++) {
		var a = t[i];
		r?.has(a) ? (a.f |= oe, zn(a, document.createDocumentFragment())) : V(t[i], n);
	}
}
var Ir;
function Lr(e, t, n, r, i, o = null) {
	...
	if (t & 4) {
		var u = e;
		s = T ? D(/* @__PURE__ */ un(u)) : u.appendChild(F());
	}
	T && Re();
	...
	function g(e) {
		v.effect.f & 16384 || (v.pending.delete(e), v.fallback = d, zr(v, p, s, t, r), d !== null && (p.length === 0 ? d.f & 33554432 ? (d.f ^= oe, Vr(d, null, s)) : Ln(d) : Fn(d, () => {
			d = null;
		})));
	}
	function _(e) {
	...
	var v = {
		effect: kn(() => {
			...
			for (var c = /* @__PURE__ */ new Set(), u = j, v = pn(), y = 0; y < e; y += 1) {
				T && E.nodeType === 8 && E.data === "]" && (s = E, a = !0, Le(!1));
				var b = p[y], x = r(b, y), S = h ? null : l.get(x);
				S ? (S.v && $t(S.v, b), S.i && $t(S.i, y), v && u.unskip_effect(S.e)) : (S = Br(l, h ? s : Ir ??= F(), b, x, y, i, t, n), h || (S.e.f |= oe), l.set(x, S)), c.add(x);
			}
			if (e === 0 && o && !d && (h ? d = B(() => o(s)) : (d = B(() => o(Ir ??= F())), d.f |= oe)), e > c.size && Ce("", "", ""), T && e > 0 && D(Be()), !h) if (m.set(u, c), v) {
...
function zr(e, t, n, r, i) {
	var a = (r & 8) != 0, o = t.length, s = e.items, l = Rr(e.effect.first), u, d = null, f, p = [], m = [], h, g, _, v;
	if (a) for (v = 0; v < o; v += 1) h = t[v], g = i(h, v), _ = s.get(g).e, _.f & 33554432 || (_.nodes?.a?.measure(), (f ??= /* @__PURE__ */ new Set()).add(_));
	for (v = 0; v < o; v += 1) {
		if (h = t[v], g = i(h, v), _ = s.get(g).e, e.outrogroups !== null) for (let t of e.outrogroups) t.pending.delete(_), t.done.delete(_);
		if (_.f & 8192 && (Ln(_), a && (_.nodes?.a?.unfix(), (f ??= /* @__PURE__ */ new Set()).delete(_))), _.f & 33554432) if (_.f ^= oe, _ === l) Vr(_, null, n);
		else {
			var y = d ? d.next : l;
...
var qr = Symbol("is custom element"), Jr = Symbol("is html"), Yr = be ? "link" : "LINK";
function Xr(e) {
	if (T) {
		var t = !1, n = () => {
			if (!t) {
...
function Zr(e, t, n, r) {
	var i = Qr(e);
	T && (i[t] = e.getAttribute(t), t === "src" || t === "srcset" || t === "href" && e.nodeName === Yr) || i[t] !== (i[t] = n) && (t === "loading" && (e[pe] = n), n == null ? e.removeAttribute(t) : typeof n != "string" && ei(e).includes(t) ? e[t] = n : e.setAttribute(t, n));
}
function Qr(e) {
	return e[me] ??= {
...
function ti(e, t, n = t) {
	...
	ut(e, "input", async (i) => {
		...
		if (a = ni(e) ? ri(a) : a, n(a), j !== null && r.add(j), await ar(), a !== (a = t())) {
	...
	}), (T && e.defaultValue !== e.value || X(t) == null && e.value) && (n(ni(e) ? ri(e.value) : e.value), j !== null && r.add(j)), Dn(() => {
		var n = t();
		if (e === document.activeElement) {
			var i = j;
			if (r.has(i)) return;
		}
		ni(e) && n === ri(e.value) || e.type === "date" && !n && !e.value || n !== e.value && (e.value = n ?? "");
	});
}
function ni(e) {
	var t = e.type;
...
function ci(t, n, r, i) {
	var a = !e || (r & 2) != 0, o = (r & 8) != 0, s = (r & 16) != 0, c = i, l = !0, u = void 0, f = () => s && a ? (u ??= /* @__PURE__ */ yt(i), Y(u)) : (l && (l = !1, c = s ? X(i) : i), c);
	let p;
	if (o) {
	...
	return (function(e, t) {
		if (arguments.length > 0) {
			let n = t ? Y(b) : a && o ? rn(e) : e;
			return P(b, n), y = !0, c !== void 0 && (c = n), e;
		}
		return Hn && y || x.f & 16384 ? b.v : Y(b);
	});
}
//#endregion
...
var ui = class {
	...
	constructor(e) {
		...
		let r = new Proxy({
			...
			has(e, r) {
				return r === fe ? !0 : (Y(t.get(r) ?? n(r, Reflect.get(e, r))), Reflect.has(e, r));
			},
			set(e, r, i) {
...
typeof HTMLElement == "function" && (di = class extends HTMLElement {
	...
	async connectedCallback() {
		if (this.$$cn = !0, !this.$$c) {
			...
			for (let e of this.attributes) {
				...
				t in this.$$d || (this.$$d[t] = fi(t, e.value, this.$$p_d, "toProp"));
			}
			...
			this.$$c = li({
				...
				Dn(() => {
					...
					for (let e of l(this.$$c)) {
						...
						this.$$d[e] = this.$$c[e];
						let t = fi(e, this.$$d[e], this.$$p_d, "toAttribute");
	...
	attributeChangedCallback(e, t, n) {
		this.$$r || (e = this.$$g_p(e), this.$$d[e] = fi(e, n, this.$$p_d, "toProp"), this.$$c?.$set({ [e]: this.$$d[e] }));
	}
...
var hi = /* @__PURE__ */ Q("<div class=\"loading-state svelte-11pw7by\">Loading...</div>"), gi = /* @__PURE__ */ Q("<div class=\"redirect-copy-group svelte-11pw7by\"><input type=\"text\" class=\"input-field readonly text-wrap svelte-11pw7by\" readonly=\"\"/> <button class=\"btn-primary copy-btn svelte-11pw7by\">Copy</button></div> <p class=\"helper-text svelte-11pw7by\">This auto-generated URI must be registered in your Tidal Developer Applications.</p>", 1), _i = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-11pw7by\">+ Add Account</button>"), vi = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-11pw7by\">✓ Authenticated</span>"), yi = /* @__PURE__ */ Q("<span class=\"status-badge warning svelte-11pw7by\">⚠ Not Authenticated</span>"), bi = /* @__PURE__ */ Q("<span class=\"status-badge active svelte-11pw7by\">● Active</span>"), xi = /* @__PURE__ */ Q("<div class=\"account-item svelte-11pw7by\"><div class=\"account-info svelte-11pw7by\"><div class=\"account-name svelte-11pw7by\"> </div> <div class=\"account-badges svelte-11pw7by\"><!> <!></div></div> <div class=\"account-actions svelte-11pw7by\"><button class=\"link-btn svelte-11pw7by\">⚙️ Edit</button> <button class=\"link-btn svelte-11pw7by\"> </button> <button> </button> <button class=\"btn-danger svelte-11pw7by\">✕</button></div></div>"), Si = /* @__PURE__ */ Q("<div class=\"empty-accounts svelte-11pw7by\">No accounts added yet. Click \"Add Account\" to get started.</div>"), Ci = /* @__PURE__ */ Q("<div class=\"settings-section svelte-11pw7by\"><div class=\"section-header svelte-11pw7by\"><h3 class=\"section-title svelte-11pw7by\">Global Redirect URI (Immutable)</h3> <button class=\"btn-ghost svelte-11pw7by\"> </button></div> <!></div> <div class=\"settings-section svelte-11pw7by\"><div class=\"section-header svelte-11pw7by\"><h3 class=\"section-title svelte-11pw7by\"> </h3> <!></div> <div class=\"accounts-list svelte-11pw7by\"></div></div>", 1), wi = /* @__PURE__ */ Q("<div class=\"modal-overlay svelte-11pw7by\"><div class=\"modal-content svelte-11pw7by\"><div class=\"modal-header svelte-11pw7by\"><h3 class=\"modal-title svelte-11pw7by\"> </h3> <button class=\"close-btn svelte-11pw7by\">✕</button></div> <div class=\"modal-body svelte-11pw7by\"><label class=\"form-field svelte-11pw7by\"><span class=\"field-label svelte-11pw7by\">Account Name</span> <input type=\"text\" placeholder=\"My Tidal Account\" class=\"input-field svelte-11pw7by\"/></label> <label class=\"form-field svelte-11pw7by\"><span class=\"field-label svelte-11pw7by\">Client ID</span> <input type=\"text\" placeholder=\"Enter Tidal Client ID\" class=\"input-field svelte-11pw7by\"/></label> <label class=\"form-field svelte-11pw7by\"><span class=\"field-label svelte-11pw7by\">Client Secret</span> <div class=\"password-wrapper svelte-11pw7by\"><input placeholder=\"Enter Tidal Client Secret\" class=\"input-field svelte-11pw7by\"/> <button type=\"button\" class=\"toggle-visibility svelte-11pw7by\"> </button></div></label></div> <div class=\"modal-footer svelte-11pw7by\"><button class=\"btn-ghost svelte-11pw7by\">Cancel</button> <button class=\"btn-primary svelte-11pw7by\"> </button></div></div></div>"), Ti = /* @__PURE__ */ Q("<section class=\"plugin-card svelte-11pw7by\"><div class=\"card-header svelte-11pw7by\"><div class=\"header-left svelte-11pw7by\"><h2 class=\"card-title svelte-11pw7by\">Tidal</h2> <span class=\"type-badge svelte-11pw7by\">Streaming Service</span></div></div> <!></section> <!>", 1), Ei = {
	hash: "svelte-11pw7by",
...
function Di(e, t) {
	Ke(t, !1), Ur(e, Ei);
	let n = ci(t, "apiBase", 12, ""), r = /* @__PURE__ */ N([]), i = /* @__PURE__ */ N(""), a = /* @__PURE__ */ N(!1), o = /* @__PURE__ */ N(!0), s = /* @__PURE__ */ N(!1), c = /* @__PURE__ */ N("add"), l = /* @__PURE__ */ N({
		id: null,
		account_name: "",
		client_id: "",
		client_secret: ""
	...
	ai();
	var x = Ti(), S = dn(x), C = R(L(S), 2), w = (e) => {
		$(e, hi());
	}, ee = (e) => {
		var t = Ci(), n = dn(t), o = L(n), s = R(L(o), 2), c = L(s, !0);
		O(s), O(o);
		var l = R(o, 2), u = (e) => {
			var t = gi(), n = dn(t), r = L(n);
			Xr(r);
			var a = R(r, 2);
			O(n), ze(2), ti(r, () => Y(i), (e) => P(i, e)), Z("click", a, () => {
		...
		Lr(S, 5, () => Y(r), Nr, (e, t) => {
			...
			var C = R(b, 2);
			O(f), O(n), On(() => {
				Sr(a, (Y(t), X(() => Y(t).display_name || Y(t).account_name))), Sr(g, (Y(t), X(() => Y(t).is_authenticated ? "Reauthenticate" : "Authenticate"))), x = Kr(b, 1, "btn-ghost svelte-11pw7by", null, x, { active: Y(t).is_active }), Sr(S, (Y(t), X(() => Y(t).is_active ? "Deactivate" : "Activate")));
			...
			Sr(c, Y(a) ? "Expand" : "Collapse"), Sr(g, `Accounts (${(Y(r), X(() => Y(r).length)) ?? ""}/25)`);
	...
	var te = R(S, 2), ne = (e) => {
		var n = wi(), r = L(n), i = L(r), a = L(i), o = L(a, !0);
		O(a);
		var s = R(a, 2);
		O(i);
		...
		O(te), O(w), O(r), O(n), On(() => {
			Sr(o, Y(c) === "add" ? "Add Tidal Account" : "Edit Tidal Account"), Zr(x, "type", Y(d) ? "text" : "password"), Sr(C, Y(d) ? "🙈" : "👁️"), Sr(ne, Y(c) === "add" ? "Add Account" : "Save Changes");
		}), Z("click", s, h), ti(m, () => Y(l).account_name, (e) => Qt(l, Y(l).account_name = e)), ti(v, () => Y(l).client_id, (e) => Qt(l, Y(l).client_id = e)), ti(x, () => Y(l).client_secret, (e) => Qt(l, Y(l).client_secret = e)), Z("input", x, () => P(u, !0)), Z("click", S, () => P(d, !Y(d))), Z("click", ee, h), Z("click", te, g), Z("click", r, ii(function(e) {
			si.call(this, t, e);
		})), Z("click", n, h), $(e, n);
	};
	return Mr(te, (e) => {
...
customElements.define("tidal-dashboard-card", mi(Di, { apiBase: {} }, [], [], { mode: "open" }));
//#endregion
