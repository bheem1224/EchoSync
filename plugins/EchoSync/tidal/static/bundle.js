...
function Ci(e, t) {
	...
	var x = xi(), S = rn(x), C = L(I(S), 2), w = (e) => {
		...
		var l = L(o, 2), u = (e) => {
			...
			Kr(r);
			var a = L(r, 2);
			O(n), Fe(2), Zr(r, () => Y(i), (e) => P(i, e)), Z("click", a, () => {
