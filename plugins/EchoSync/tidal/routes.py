...
def list_accounts():
    ...
    try:
        ...
        if not client_id or not client_secret_present:
            ...
            svc_id = (
                db.get_service_id(3106502486)
                or db.get_service_id("EchoSync.Tidal")
                or db.get_service_id("tidal")
            )
            if svc_id:
                client_id = (
                    client_id or db.get_service_config(svc_id, "client_id") or ""
                )
                client_secret_present = client_secret_present or bool(
                    db.get_service_config(svc_id, "client_secret")
                )
        ...
        return JSONResponse(
            content={"accounts": accounts, "redirect_uri": redirect_uri}
        )
    except Exception as e:
        logger.error(f"Error getting Tidal accounts: {e}", exc_info=True)
        return JSONResponse(
            content={"error": "Failed to get Tidal accounts"}, status_code=500
        )
...
async def create_account(request: Request):
    ...
    try:
        ...
        if not client_id or not client_secret:
            return JSONResponse(
                content={"error": "client_id and client_secret are required"},
                status_code=400,
            )
        ...
        return JSONResponse(
            content={"error": "Failed to create Tidal account"}, status_code=500
        )
...
def get_account(account_id: int):
    ...
    try:
        ...
        return JSONResponse(
            content={"error": "Failed to get Tidal account"}, status_code=500
        )
...
async def update_account(account_id: int, request: Request):
    ...
    try:
        ...
        return JSONResponse(
            content={"error": "Failed to update Tidal account"}, status_code=500
        )
...
async def activate_account(account_id: int, request: Request):
    ...
    try:
        ...
        return JSONResponse(
            content={"error": "Failed to activate Tidal account"}, status_code=500
        )
...
def delete_account(account_id: int):
    ...
    try:
        ...
        return JSONResponse(
            content={"error": "Failed to delete Tidal account"}, status_code=500
        )
...
async def set_redirect_uri(request: Request):
    ...
    try:
        ...
        if not redirect_uri:
            return JSONResponse(
                content={"error": "redirect_uri is required"}, status_code=400
            )
        ...
        return JSONResponse(
            content={"error": "Failed to set redirect URI"}, status_code=500
        )
...
async def begin_auth(request: Request):
    ...
    try:
        ...
        if not client_id:
            return JSONResponse(
                content={"error": "Tidal client_id not configured"}, status_code=400
            )
        ...
        return JSONResponse(
            content={"error": "Failed to initiate Tidal authentication"},
            status_code=500,
        )
