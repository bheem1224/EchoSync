...
var y = 1024, b = 2048, x = 4096, re = 8192, ie = 16384, ae = 32768, S = 1 << 25, oe = 65536, C = 1 << 19, se = 1 << 20, w = 65536, ce = 1 << 21, le = 1 << 22, ue = 1 << 23, de = Symbol("$state"), fe = Symbol("legacy props"), pe = Symbol(""), me = Symbol("attributes"), he = Symbol("class"), ge = Symbol("style"), _e = Symbol("text"), ve = Symbol("form reset"), ye = new class extends Error {
...
function nt(e) {
	if (e !== null) for (let t of e) !(t.f & 2) || !(t.f & 65536) || (t.f ^= w, nt(t.deps));
}
function rt(e, t, n) {
	e.f & 2048 ? t.add(e) : e.f & 4096 && n.add(e), nt(e.deps), A(e, y);
}
//#endregion
...
var st = null, ct = null, j = null, lt = null, M = null, ut = null, dt = !1, ft = !1, pt = null, mt = null, ht = 0, gt = 1, _t = class t {
	id = gt++;
	#e = !1;
	linked = !0;
	#t = null;
	...
	#g() {
		...
		this.#r.clear(), lt = this, bt(i), bt(r), lt = null, this.#s?.resolve();
		var c = j;
	...
	flush() {
		try {
			...
			ht = 0, ut = null, pt = null, mt = null, ft = !1, j = null, M = null, Wt.clear();
		}
	}
	discard() {
		...
		for (let l = st; l !== null; l = l.#n) {
			...
			if (l.#e) {
				...
				if (r.length === 0) e && l.discard();
					...
					if (s.length > 0) for (let e of this.#l) !(e.f & 155648) && St(e, s, a) && (e.f & 4194320 ? (A(e, b), l.schedule(e)) : l.#u.add(e));
					if (l.#c.length > 0 && !l.#m) {
						l.apply();
	...
	apply() {
		...
		for (let e = st; e !== null; e = e.#n) if (!(e === this || e.is_fork)) {
			var t = !1;
			if (e.id < this.id) {
	...
	schedule(t) {
		...
		for (var n = t; n.parent !== null;) {
			n = n.parent;
			var r = n.f;
			if (pt !== null && n === G && (e || (H === null || !(H.f & 2)) && !it)) return;
			if (r & 96) {
				if (!(r & 1024)) return;
				n.f ^= y;
			}
...
function xt(e, t, n, r) {
	if (!n.has(e) && (n.add(e), e.reactions !== null)) for (let i of e.reactions) {
		let e = i.f;
		e & 2 ? xt(i, t, n, r) : e & 4194320 && !(e & 2048) && St(i, t, r) && (A(i, b), Ct(i));
	}
}
function St(e, t, n) {
	let r = n.get(e);
...
function It(e, t, n) {
	...
	return En(() => {
		...
		if (s) {
			...
			if (r.b?.is_rendered()) i.async_deriveds.get(t)?.reject(Ft);
			else for (let e of c.values()) e.reject(Ft);
			c.add(n), i.async_deriveds.set(t, n);
		}
		let u = (e, t = void 0) => {
			l?.(), c.delete(n), t !== Ft && (i.activate(), t ? (o.f |= ue, Jt(o, t)) : (o.f & 8388608 && (o.f ^= ue), Jt(o, e)), i.deactivate());
		};
...
function Bt(e) {
	var t = zt(e);
	if (!e.equals(t) && (e.wv = Yn(), (!j?.is_fork || e.deps === null) && (j === null ? e.v = t : (j.capture(e, t, !0), lt?.capture(e, t, !0)), e.deps === null))) {
		A(e, y);
		return;
	}
...
function Vt(e) {
	if (e.effects !== null) for (let t of e.effects) (t.teardown || t.ac) && (t.teardown?.(), t.ac?.abort(ye), t.fn !== null && (t.teardown = ee), t.ac = null, er(t, 0), jn(t));
}
function Ht(e) {
...
function F(e, t, n = !1) {
	return H !== null && (!U || H.f & 131072) && qe() && H.f & 4325394 && (q === null || !q.has(e)) && je(), Jt(e, n ? Qt(t) : t, mt);
}
function Jt(e, t, n = null) {
	if (!e.equals(t)) {
		...
		if (r.capture(e, t), e.f & 2) {
			let t = e;
			e.f & 2048 && zt(t), M === null && tt(t);
		}
		e.wv = Yn(), Zt(e, b, n), qe() && G !== null && G.f & 1024 && !(G.f & 96) && (X === null ? Wn([e]) : X.push(e)), !r.is_fork && Ut.size > 0 && !Gt && Yt();
	}
	return t;
}
function Yt() {
	...
	if (r !== null) for (var i = qe(), a = r.length, o = 0; o < a; o++) {
		...
		if (!(!i && s === G)) {
			...
			if (l && A(s, t), c & 131072) Ut.add(s);
				...
				var u = s;
				M?.delete(u), c & 65536 || (c & 512 && (G === null || !(G.f & 2097152)) && (s.f |= w), Zt(u, x, n));
			} else if (l) {
				var d = s;
				c & 16 && N !== null && N.add(d), n === null ? Ct(d) : n.push(d);
			}
		}
	}
}
...
function Rn(e, t) {
	if (e.f & 8192) {
		e.f ^= re, e.f & 1024 || (A(e, b), _t.ensure().schedule(e));
...
function Xn(e) {
	...
	if (t & 2 && (e.f &= ~w), t & 4096) {
		for (var n = e.deps, r = n.length, i = 0; i < r; i++) {
			var a = n[i];
			if (Xn(a) && Bt(a), a.wv > e.wv) return !0;
		}
		t & 512 && M === null && A(e, y);
	}
	return !1;
...
function Zn(t, n, r = !0) {
	...
	if (i !== null && !(!e && q !== null && q.has(t))) for (var a = 0; a < i.length; a++) {
		var o = i[a];
		o.f & 2 ? Zn(o, n, !1) : n === o && (r ? A(o, b) : o.f & 1024 && A(o, x), Ct(o));
	}
}
function Qn(e) {
...
function $n(e, t) {
	...
	if (n === null && t.f & 2 && (J === null || !c.call(J, t))) {
		var o = t;
		o.f & 512 && (o.f ^= 512, o.f &= ~w), o.v !== i && tt(o), Vt(o), er(o, 0);
	}
}
function er(e, t) {
	var n = e.deps;
...
function Z(e) {
	...
	if (t) {
		...
		if (V) {
			var a = i.v;
			return (!(i.f & 1024) && i.reactions !== null || ir(i)) && (a = zt(i)), Wt.set(i, a), a;
		}
		var o = (i.f & 512) == 0 && !U && H !== null && (Vn || (H.f & 512) != 0), s = (i.f & ae) === 0;
		Xn(i) && (o && (i.f |= 512), Bt(i)), o && !s && (Ht(i), rr(i));
	}
...
function rr(e) {
	if (e.f |= 512, e.deps !== null) for (let t of e.deps) (t.reactions ??= []).push(e), t.f & 2 && !(t.f & 512) && (Ht(t), rr(t));
}
function ir(e) {
	if (e.v === i) return !0;
...
function qr(e, n, r, i) {
	var a = !t || (r & 2) != 0, o = (r & 8) != 0, s = (r & 16) != 0, c = i, l = !0, u = void 0, d = () => s && a ? (u ??= /* @__PURE__ */ Pt(i), Z(u)) : (l && (l = !1, c = s ? ar(i) : i), c);
	let p;
	if (o) {
...
var Yr = class {
	...
	constructor(t) {
		...
		}), !e && (!t?.props?.$$host || t.sync === !1) && vt(), this.#e = i.$$events;
...
function li(e, t) {
	...
	Gr();
	var ne = si(), y = I(ne), b = I(y), x = L(I(b), 2), re = I(x), ie = (e) => {
		$(e, ei());
	};
	jr(re, (e) => {
		Z(m) && e(ie);
	...
	var w = L(b, 2), ce = I(w, !0);
	O(w), O(y);
	var le = L(y, 2), ue = (e) => {
		$(e, ii());
	}, de = (e) => {
		var t = oi(), n = L(I(t), 2), c = I(n), l = L(I(c), 2);
		Ir(l), Re(2), O(c);
		...
		On(() => Rr(ie, "mappings", (Z(o), ar(() => JSON.stringify(Z(o)))))), O(re);
		var ae = L(re, 2), S = I(ae), oe = I(S, !0);
		O(S);
		var C = L(S, 2), se = (e) => {
			var t = ai(), n = I(t, !0);
			O(t), On(() => {
		...
		jr(w, (e) => {
			...
			Lr(y, "type", Z(p) ? "text" : "password"), Lr(y, "placeholder", Z(s) ? "••••••••" : "Enter password"), xr(x, Z(p) ? "🙈" : "👁️"), S.disabled = Z(u), xr(oe, Z(u) ? "Saving..." : "Save Settings");
		}), Hr(l, () => Z(r), (e) => F(r, e)), Hr(_, () => Z(i), (e) => F(i, e)), Hr(y, () => Z(a), (e) => F(a, e)), fr("click", b, () => F(p, !Z(p))), fr("es-path-update", ie, (e) => F(o, e.detail)), fr("click", S, ee), $(e, t);
	};
	return jr(le, (e) => {
		Z(l) ? e(ue) : Z(f) || e(de, 1);
	}), O(ne), On(() => xr(ce, Z(f) ? "Expand" : "Collapse")), fr("click", w, () => F(f, !Z(f))), $(e, ne), Ke(v);
}
customElements.define("navidrome-dashboard-card", $r(li, { apiBase: {} }, [], [], { mode: "open" }));
//#endregion
