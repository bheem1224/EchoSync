...
var ei = /* @__PURE__ */ Q("<span class=\"status-badge active svelte-6qi2q9\">● Active</span>"), ti = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-6qi2q9\">✓ Authenticated</span>"), ni = /* @__PURE__ */ Q("<span class=\"status-badge success svelte-6qi2q9\">● Connected</span>"), ri = /* @__PURE__ */ Q("<span class=\"status-badge warning svelte-6qi2q9\">⚠ Disconnected</span>"), ii = /* @__PURE__ */ Q("<div class=\"loading-state svelte-6qi2q9\">Loading...</div>"), ai = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-6qi2q9\"> </button>"), oi = /* @__PURE__ */ Q("<button class=\"btn-ghost svelte-6qi2q9\"> </button>"), si = /* @__PURE__ */ Q("<div class=\"settings-section svelte-6qi2q9\"><h3 class=\"section-title svelte-6qi2q9\">Server Configuration</h3> <div class=\"form-grid svelte-6qi2q9\"><label class=\"form-field svelte-6qi2q9\"><span class=\"field-label svelte-6qi2q9\">Server URL</span> <input type=\"text\" placeholder=\"http://192.168.1.100:4533\" class=\"input-field svelte-6qi2q9\"/> <span class=\"helper-text svelte-6qi2q9\">Enter your Navidrome server URL (include port, typically :4533)</span></label> <label class=\"form-field svelte-6qi2q9\"><span class=\"field-label svelte-6qi2q9\">Username</span> <input type=\"text\" placeholder=\"Enter username\" class=\"input-field svelte-6qi2q9\"/></label> <label class=\"form-field svelte-6qi2q9\"><span class=\"field-label svelte-6qi2q9\">Password</span> <div class=\"password-wrapper svelte-6qi2q9\"><input class=\"input-field svelte-6qi2q9\"/> <button type=\"button\" class=\"toggle-visibility svelte-6qi2q9\"> </button></div></label> <div class=\"path-mappings svelte-6qi2q9\"><echosync-path-mapping-editor></echosync-path-mapping-editor></div> <div class=\"actions-row svelte-6qi2q9\"><button class=\"btn-primary svelte-6qi2q9\"> </button> <!> <!></div></div></div>", 2), ci = /* @__PURE__ */ Q("<section class=\"plugin-card svelte-6qi2q9\"><div class=\"card-header svelte-6qi2q9\"><div class=\"header-left svelte-6qi2q9\"><h2 class=\"card-title svelte-6qi2q9\">Navidrome</h2> <div class=\"badges svelte-6qi2q9\"><!> <!> <!></div></div> <button class=\"btn-ghost svelte-6qi2q9\"> </button></div> <!></section>"), li = {
	hash: "svelte-6qi2q9",
...
function ui(e, t) {
	...
	async function ee() {
		try {
			P(h, !0), await fetch(`${n()}/navidrome/activate`, { method: "POST" }), await g();
		} catch (e) {
	...
	async function ne() {
		try {
			P(d, !0), (await (await fetch(`${n()}/navidrome/test-connection`, { method: "POST" })).json())?.connected && await g();
		} catch (e) {
...
customElements.define("navidrome-dashboard-card", $r(ui, { apiBase: {} }, [], [], { mode: "open" }));
//#endregion
